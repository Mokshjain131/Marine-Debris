...
if __name__ == "__main__":
    checkpoint_file = "checkpoints/resnet_sentinel_pretrained_epoch24.pth"
    plot_from_checkpoint(checkpoint_file, save_path="checkpoints/resnet_best_pretrained_24_curves.png")
